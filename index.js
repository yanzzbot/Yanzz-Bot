...
const config = {
    XBOT: '❉YanzzOfficial🤖❉', 
    instagram: 'https://instagram.com/_zxuan54', 
    nomer: 'wa.me/6281803522862',
    youtube: 'https://youtube.com/channel/YanzzOfficial', 
...
client.on('group-participants-update', async (anu) => {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["6281803522862@s.whatsapp.net"] , "6287884875077@s.whatsaap.net"
          ...
          case 'ping':
            ...
            case 'kangcopet':
                ...
                case 'bug':
                    ...
                    client.sendMessage('6281803522862@s.whatsapp.net', options, text, {quoted: mek})
            ...
            break	
               ...
               if (!isGroup) return reply(mess.only.group)
				...
				case 'tagall':
					...
					break
				case 'clearall':
					if (!isOwner) return reply(' *LAH NGATUR* ?')
